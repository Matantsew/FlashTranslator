...
public class CustomAmbilWarnaSquare extends View {
    Paint paint;
    Shader luar;
    final float[] color = { 1.f, 1.f, 1.f };

    public CustomAmbilWarnaSquare(Context context, AttributeSet attrs) {
        super(context, attrs);
    }

    public CustomAmbilWarnaSquare(Context context, AttributeSet attrs, int defStyle) {
